...
- [ ] Create a **personal AWS account** (own credit card, not corporate/internal).
- [ ] Set an **AWS Budget alarm** (e.g., alert at $10).
- [ ] Confirm internal policy if considering any employee account/credit (default: don't).
